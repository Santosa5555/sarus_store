...
const Header = () => {
    ...
    const isSmall = useMediaQuery({ query: "(max-width: 780px)" });
    return (
        <div>
                ...
                <nav className='flex space-x-6 items-center mx-auto'>
                    ...
                    <form action="" className=' rounded-md relative   '>
                        ...
                        <input
                            ...
                            className="border-none mt-2  mr-4 p-2 ml-6 rounded-md focus:outline-none bg-white focus:ring-2 focus:ring-blue-500 "
                        // onKeyUp={}
                        />
